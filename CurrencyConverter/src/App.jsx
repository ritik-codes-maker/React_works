...
function App() {
  ...
  const convertAmount = ()=>{
    const amountConversion = amount * currencyInfo[to];
    setConvertedAmount(amountConversion)
  }
  return (
    <>
     <div
            ...
            style={{
                backgroundImage: `url('https://i.pinimg.com/1200x/ae/8c/74/ae8c740ee29e3fd29a7fcba202716b41.jpg')`,
            }}
        >
